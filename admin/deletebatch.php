...
?>
<h3 class="header smaller lighter blue">Delete Batch Info</h3>
								<form class="form-horizontal" role="form" method="post">
								        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Batch name: </label>

										<div class="col-sm-9">
											<input type="text" id="form-field-1" placeholder="Enter name" name="batchname" class="col-xs-10 col-sm-5" />
										</div>
										<br>
...
<?php 
	...
	if(isset($_POST['submit'])){
		...
		$qry="DELETE FROM  batch WHERE batchname ='$batchname'";
