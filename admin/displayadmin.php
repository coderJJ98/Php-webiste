...
<?php 
		...
		{
                $str.="<tr><td>".$row["username"]."</td><td>" .$row["fname"]."</td><td>".$row["lname"]."</td><td>".$row["contactno"]."</td><td>".$row["email"]."</td><td><img src='images\\" .$row["img"]."' height='100px' width='100px'></td></tr>";
